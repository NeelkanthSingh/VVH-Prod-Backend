...
uploadController.fileUpload = async (req, res) => {
  ...
  try {
    await uploadToGoogleDrive(email, pdfName, docName, extension);
        ...
        try{
            ...
            if (folderId != "Folder not found") {
                ...
                spaces: 'drive',
                    ...
                    if (err) {return console.error('Error uploading PDF:', err); throw err;}
                ...
                drive.files.create({
                    ...
                    if(err) {return console.error('Error creating folder:', err); throw err;}
